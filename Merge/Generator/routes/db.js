...
const Album = require('../bin/db/Album');
const Artist = require('../bin/db/Artist');
const Song = require('../bin/db/Song');
const generateFakeDate = require('../bin/scripts/generateFakeDate');
const getRandomIntInclusive = require('../bin/scripts/getRandomIntInclusive');
const shuffle = require('../bin/scripts/shuffle');
const findArtists = require('../middlewares/findArtists');
