...
$(document).ready(function () {
  ...
  formAuthor[0].addEventListener('submit', event => {
    ...
    $.ajax({
      url: `/api/group/${fname.value}${lname.value ? ' ' + lname.value : ''}/dates`,
      data: {},
      success: (res) => {
  ...
  function generateDateQuestion (nbQuestion) {
    ...
    $.ajax({
      url: `/api/questions/gen10/artistDates?nbQuestion=${nbQuestion}`,
      data: {},
      success: (res) => {
  ...
  formAuthor[1].addEventListener('submit', event => {
    ...
    $.ajax({
      url: `/api/group/${fnameAlbum.value}${lnameAlbum.value ? ' ' + lnameAlbum.value : ''}/album`,
      data: {},
      success: (res) => {
  ...
  function generateAlbumQuestion (nbQuestion) {
    ...
    $.ajax({
      url: `/api/questions/gen10/artistAlbums?nbQuestion=${nbQuestion}`,
      data: {},
      success: (res) => {
  ...
  formAuthor[2].addEventListener('submit', event => {
    ...
    $.ajax({
      url: `/api/group/${fname.value}${lname.value ? ' ' + lname.value : ''}/chanson`,
      data: {},
      success: (res) => {
  ...
  function generateChansonsQuestion (nbQuestion) {
    ...
    $.ajax({
      url: `/api/questions/gen10/artistSongs?nbQuestion=${nbQuestion}`,
      data: {},
      success: (res) => {
  ...
  formAuthor[3].addEventListener('submit', event => {
    ...
    $.ajax({
      url: `/api/group/${fnameAll.value}${lnameAll.value ? ' ' + lnameAll.value : ''}/all`,
      data: {},
      success: (res) => {
        console.log(res);
  ...
  function generateAllQuestion (nbQuestion) {
    ...
    $.ajax({
      url: `/api/questions/gen10/allRandom?nbQuestion=${nbQuestion}`,
      data: {},
      success: (res) => {
